...
export type Product = {
  ...
  status?: "new" | "hot" | "sale";
  variant?: "taylor-swift" | "fearless" | "speak-now" | "red" | "1989" | "reputation" | "lover" | "folklore" | "evermore" | "midnights" | "ttpd";
  isFeatured?: boolean;
};
...
export type AllSanitySchemaTypes = Order | Product | Category | Brand | Blog | Blogcategory | BlockContent | Author | Address | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type DEAL_PRODUCTSResult = Array<{
  ...
  status?: "hot" | "new" | "sale";
  variant?: "1989" | "evermore" | "fearless" | "folklore" | "lover" | "midnights" | "red" | "reputation" | "speak-now" | "taylor-swift" | "ttpd";
  isFeatured?: boolean;
}>;
...
// Query: '*[_type == "product" && slug.current == $slug]{ brandName, brand->title, title }'
export type BRAND_QUERYResult = "*[_type == \"product\" && slug.current == $slug]{ brandName, brand->title, title }";
